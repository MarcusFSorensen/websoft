...
<p>At the moment I do not like PHP very much. I feel like it is a bit clunky to me compared to using js. When html and PHP is being used in the same document it can become
    A little confusing to me. To some extent PHP reminds me of java. This is mostly when it came to using prepared statement as it feels similar to java in that sense. Other than that
    it felt a bit foreign especially with the big use of $. I felt like this assignment was much harder than others. Not the actual coding part but to set it up and test it. I had to 
    move alot of files to my xampp htdocs to be able to test the php files that I would then put on vs code. I also had a problem with accessing my mysql from the php file but found
    out it was because my sever was version 8+ and was using SHa-256 authentication which php didn't support. for the coding part I took help from looking at your code examples and
    reused the majority of your code. Atm I aimed for a 3 but will come back to improve it if I have time before friday.
    My TIL is how to use  PHP to do CRUD on a database and how to set up xampp properly and use mysql through xampp.
</p>
</section>

...
<button type="button" class="collapsible">Open a10 report</button>
<div class=report-content>
  <p>
  I think the process of implementing our project went well. We started out by designing the database which took longer than expected I believe since we haven’t made a database of that size before. But we managed it by using ER diagrams before doing EER and implementation. During the project my main focus area was the server/rest api and it helped me a lot to look at our assignment 4 where express was used to know how to set up the routes. For the rest api I had to spent some extra time to learn how to get the different parts of a request such as body and header. I also had to change the naming of the routes to make it as a rest api with resources as I started out naming it incorrectly. I solved this by looking at some of my old work when we did a rest api in network applications. What took the longest to implement in the rest api was authentication with JWT and to do hashing and encryption of the user password since I have not worked with any of those 2 things before. 
Once I was done doing the server I would help out filling the database with data and then later help out with the front end implementation. The front end implementation was a little but difficult for me in the start as I’m still not very good with HTML and CSS but as I worked with it got easier. Whenever I have issues with HTML or CSS I usually use the website w3Schools which has many good examples of how implementation of HTML and CSS is done and what each attribute is affecting. It wasn’t only google that helped me though as Joakim, Rasmus and I also frequently would have meetings and help eachother out when help was needed. 
I believe that the project wasn’t easy but not very difficult either. To complete the project with a reasonable grade we had to make use of what we had learned over the week during the assignments. By doing the assignment we were well prepared for the project. On the front end we had some issues as to how to probably do CRUD operations to the rest api where we did it 2 ways. We used forms and fetch.
I believe we worked well as a team. We were able to have frequent meetings and would keep eachother updated on what everyone was working on and if anyone needed help.
<p>
<p>
I think this has been a very good course. The lectures was very helpful and clear followed by good exercises/assignments to implement what was taught. All the lectures was also recorded and uploaded so you could watch them at your own pace if there was something you had missed the first time. I believe all the assignments was good. Not too easy but not too difficult either. The whole course on canvas and just in general was also very well organized which is something I have missed from teachers since often they don’t structure the courses that well whereas in this course it was very clear where everything was and how you should go about the course. If any of my friends is interested in web development I would definitely recommend this course and I would give it a grade of 9/10.
    <p>

<p>My TIL for this course is how to develop and implement a web application. We have been taught different frameworks, languages and techniques. I have also learned that
I find web development to be very interesting and that I'm gonna keep working and improving on our assignment 10 since I believe that it could be a very useful appliaction for people who likes to play the game. Myself I would love to have the application up and running for myself and friends to use.
